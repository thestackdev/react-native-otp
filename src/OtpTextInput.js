...
import { styles, _size } from "./utils";
...
const OtpTextInput = (props) => {
  ...
  const _styles = {
    renderInput: [styles.renderInput, { width: _size(digits), ...style }],
    textStyles: [styles.textStyles, fontStyle],
      ...
      <View style={[styles.container]}>
        {Array.from({ length: digits }).map((_, i) => (
          <View
            ...
            key={i}
          >
            <Text onPress={_onPress} style={[_styles.textStyles]}>
